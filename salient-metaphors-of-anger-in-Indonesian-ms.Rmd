...
`r paste(paste(get_mappings(metaphor_typebased_mapping, 'fierce')[[2]], "<br><br>", sep = ""), collapse = "")`

The most productive mapping/correspondence
...
The second most frequent mapping
...
The third most frequent mapping
...
The last most frequent mapping
