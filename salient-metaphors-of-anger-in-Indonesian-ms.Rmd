...
knitr::kable(metaphor_typebased_salience_print, caption = "Source domains of [anger]{.smallcaps} based on the type-based, lexical approach")
```
...
- In order of frequency, the subsections should describe each conceptual metaphor, as well as the mappings with examples. Contributors should focus on which aspect of the emotion the respective source domains highlight (how and why).
